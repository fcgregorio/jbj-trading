...
const sequelizeConfig =
  castedConfig[process.env.NODE_ENV ? process.env.NODE_ENV : "development"];
...
User.addHook(
  "afterSave",
  async (
    instance: Model<UserAttributes, UserCreationAttributes>,
    options: SaveOptions<UserAttributes>
  ) => {
...
export class UserHistory
  extends Model<UserHistoryAttributes, UserHistoryCreationAttributes>
  implements UserHistoryAttributes
{
...
Unit.addHook(
  "afterSave",
  async (
    instance: Model<UnitAttributes, UnitCreationAttributes>,
    options: SaveOptions<UnitAttributes>
  ) => {
...
export class UnitHistory
  extends Model<UnitHistoryAttributes, UnitHistoryCreationAttributes>
  implements UnitHistoryAttributes
{
  public historyId!: number;
  public historyUser!: string;
...
Category.addHook(
  "afterSave",
  async (
    instance: Model<CategoryAttributes, CategoryCreationAttributes>,
    options: SaveOptions<CategoryAttributes>
  ) => {
...
export class CategoryHistory
  extends Model<CategoryHistoryAttributes, CategoryHistoryCreationAttributes>
  implements CategoryHistoryAttributes
{
  public historyId!: number;
  public historyUser!: string;
...
Item.addHook(
  "afterSave",
  async (
    instance: Model<ItemAttributes, ItemCreationAttributes>,
    options: SaveOptions<ItemAttributes>
  ) => {
...
export class ItemHistory
  extends Model<ItemHistoryAttributes, ItemHistoryCreationAttributes>
  implements ItemHistoryAttributes
{
  public historyId!: number;
  public historyUser!: string;
...
export class InTransaction
  extends Model<InTransactionAttributes, InTransactionCreationAttributes>
  implements InTransactionAttributes
{
  public id!: string;
...
InTransaction.addHook(
  "afterSave",
  async (
    instance: Model<InTransactionAttributes, InTransactionCreationAttributes>,
    options: SaveOptions<InTransactionAttributes>
  ) => {
...
export class InTransactionHistory
  extends Model<
    InTransactionHistoryAttributes,
    InTransactionHistoryCreationAttributes
  >
  implements InTransactionHistoryAttributes
{
  public historyId!: number;
  public historyUser!: string;
...
export class OutTransaction
  extends Model<OutTransactionAttributes, OutTransactionCreationAttributes>
  implements OutTransactionAttributes
{
  public id!: string;
...
OutTransaction.addHook(
  "afterSave",
  async (
    instance: Model<OutTransactionAttributes, OutTransactionCreationAttributes>,
    options: SaveOptions<OutTransactionAttributes>
  ) => {
...
export class OutTransactionHistory
  extends Model<
    OutTransactionHistoryAttributes,
    OutTransactionHistoryCreationAttributes
  >
  implements OutTransactionHistoryAttributes
{
  public historyId!: number;
  public historyUser!: string;
...
export class InTransfer
  extends Model<InTransferAttributes, InTransferCreationAttributes>
  implements InTransferAttributes
{
  public id!: string;
  public index!: number;
  public item!: string;
...
export class OutTransfer
  extends Model<OutTransferAttributes, OutTransferCreationAttributes>
  implements OutTransferAttributes
{
  public id!: string;
  public index!: number;
  public item!: string;
