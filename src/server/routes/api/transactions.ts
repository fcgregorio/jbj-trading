...
import sequelize, { Category, InTransaction, InTransactionAttributes, InTransfer, Item, OutTransaction, OutTransactionAttributes, OutTransfer, Transaction, TransactionAttributes, Transfer, Unit } from '../../sequelize';
    ...
    try {
        ...
        await sequelize.transaction(async (t) => {
            ...
            items.forEach((e, index) => {
                ...
                rowData.createdAt = DateTime.fromJSDate(e.createdAt).setZone(zone).toJSON();
                rowData.updatedAt = DateTime.fromJSDate(e.updatedAt).setZone(zone).toJSON();
                rowData.deletedAt = e.deletedAt !== null ? DateTime.fromJSDate(e.deletedAt!).setZone(zone).toJSON() : null;
