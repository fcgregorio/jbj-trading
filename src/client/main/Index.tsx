...
export default function Index() {
  ...
  const [dateTimeContext, setDateTimeContext] = React.useState(DateTime.now());
  ...
  return (
    <DateTimeContext.Provider value={[dateTimeContext, setDateTimeContext]}>
      <Box
        sx={{
          display: "flex",
        }}
        ...
        >
          <Box>
            ...
            >
              ...
              <ListItemButton
                selected={
                  matchPath("/categories/*", location.pathname) !== null
                }
                key={"Categories"}
                component="a"
                href="/categories"
