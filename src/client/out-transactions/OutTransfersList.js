          ...
          <React.Fragment>
            {props.formik.values.OutTransfers.map((OutTransfer, index) => (
              ...
              >
                <TableCell>
                  <Tooltip
                    title={props.formik.values.OutTransfers[index].item}
                    placement="right"
                  >
                    <Link
                      underline="none"
                    ...
                    >
                      <Typography fontFamily="monospace" variant="body2">
                        {props.formik.values.OutTransfers[index].item.substring(
                          0,
                          8
                        )}
                      </Typography>
                ...
                <TableCell>
                  {props.formik.values.OutTransfers[index].Item.name}
                </TableCell>
                ...
                <TableCell>
                  {props.formik.values.OutTransfers[index].Item.Unit.name}
                </TableCell>
                <TableCell
                  sx={{
                    width: "1%",
