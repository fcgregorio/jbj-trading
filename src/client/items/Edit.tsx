...
export default function Edit() {
  ...
  const formik = useFormik<EditItem>({
    ...
    validationSchema: Yup.object().shape({
      ...
      safetyStock: Yup.number().required("Required"),
    ...
    onSubmit: async (values) => {
      setLocked(true);
      await axios
        .put<{ id: string }, AxiosResponse<{ id: string }>, ApiEditItem>(
    ...
    () =>
      throttle(
        async (
          ...
          await axios
            .get<{ count: number; results: Unit[] }>(`/api/units`, {
              params: {
    ...
    () =>
      throttle(
        async (
          ...
          await axios
            .get<{ count: number; results: Category[] }>(`/api/categories`, {
              params: {
                search: request.input,
                filters: {
                  showDeleted: false,
            ...
            >
              ...
              <TextField
                ...
                error={
                  ...
                  Boolean(formik.errors.safetyStock)
                }
                helperText={
              ...
              <Autocomplete
                ...
                onChange={(event: any, newValue: Unit | null) => {
                  setUnitOptions(
                    newValue ? [newValue, ...unitOptions] : unitOptions
                  );
              ...
              <Autocomplete
                ...
                onChange={(event: any, newValue: Category | null) => {
                  setCategoryOptions(
                    newValue ? [newValue, ...categoryOptions] : categoryOptions
                  );
